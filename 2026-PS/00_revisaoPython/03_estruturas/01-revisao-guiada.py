...
# e dicionários para armazanar, consultar e filtrar
# dados estruturados.
# =====================================
...
print("Primeiro livros:", titulos[0])
...
# ATENÇÃ0: 4 erros propositais. Encontre e corrija todos!
...
False},
    {"titulo": "Python fluente",    "autor": "Luciano Ramalho", "disponivel":
True},
]

print("Primeiro livro:", catalogo[3]["titulo"])

print("\mLivros disponíveis")
for livro in catalogo:
...
print("\nAutor do primeiro livros:", primeiro_autor)